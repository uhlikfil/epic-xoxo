...
class ServerGame {
    ...
    swapStartingPlayer() {
        if (this.startingPlr == 'Player 1') {
            this.startingPlr = 'Player 2'
        }
        else if (this.startingPlr == 'Player 2') {
            this.startingPlr = 'Random'
        }
        else {
            this.startingPlr = 'Player 1'
        }
        return this.startingPlr
    }
